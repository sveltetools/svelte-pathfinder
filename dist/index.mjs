...
const hasPushState = hasHistory && typeof history.pushState === 'function';
const hasWindow = typeof window !== 'undefined';
const subWindow = hasWindow && window !== window.parent;
const sideEffect = hasWindow && hasHistory && hasPushState && !subWindow;
...
function matchPattern(str, match, loose) {
...
export { back, click, fragment, goto, path, pattern, prefs, query, state, submit, url };
